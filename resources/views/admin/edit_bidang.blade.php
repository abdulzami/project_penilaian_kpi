    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Edit Bidang di {{ $nama_struktural }}</h4>
            </div>
        </div>
    ...
    <div class="card col-xl-12">
        ...
        <div class="card-body">
            <div class="basic-form">
                <form action="{{ route('update-bidang',[$id,$id2]) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label>Nama Bidang</label>
                        <input type="text" name="nama_bidang" value="{{$bidangs[0]->nama_bidang}}" class="form-control"
