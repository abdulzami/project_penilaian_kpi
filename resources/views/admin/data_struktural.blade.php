    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manajemen Struktural</li>
            </ol>
        </div>
    </div>
@endsection
@section('content')
    <a href="{{ route('create-struktural') }}"><button type="button" class="btn btn-xs mb-3 btn-primary mb-1">Tambah
            Data</button></a>
    <div class="row">
        <div class="col-12">
            <div class="card">
