...
class HomeController extends Controller
{
    public function index()
    {
        ...
        if (Auth::user()->level == 'admin') {
            ...
            $penilaian = Penilaian::where('id_pegawai', Auth::user()->id_user)->where('id_jadwal', $jadwal[0]->id_jadwal)->get();
            ...
            if ($penilaian->isEmpty()) {
                ...
                return view('pegawai.home', compact('nama_periode', 'penilaian', 'kpiperformances'));
            }
        } else {
